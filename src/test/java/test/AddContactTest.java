...
//	String password = "abc123";
	...
	public void validUserShouldBeAbleToAddCustomer() {
		...
		addContactPage.inserrtPhone(phone);
		addContactPage.inserrtAddress(address);
		addContactPage.inserrtCity(city);
		addContactPage.inserrtState(state);
		addContactPage.inserrtZip(zip);
